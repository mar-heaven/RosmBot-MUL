...
func (cc *ChatCreate) SetGroupID(i int64) *ChatCreate {
	cc.mutation.SetGroupID(i)
	return cc
}

// SetUserID sets the "user_id" field.
func (cc *ChatCreate) SetUserID(i int64) *ChatCreate {
	cc.mutation.SetUserID(i)
	return cc
}

// SetTime sets the "time" field.
func (cc *ChatCreate) SetTime(i int64) *ChatCreate {
	cc.mutation.SetTime(i)
	return cc
}

// SetMessageType sets the "message_type" field.
func (cc *ChatCreate) SetMessageType(s string) *ChatCreate {
	cc.mutation.SetMessageType(s)
	return cc
}

// SetMessageContent sets the "message_content" field.
func (cc *ChatCreate) SetMessageContent(s string) *ChatCreate {
	cc.mutation.SetMessageContent(s)
	return cc
}
...
func (cc *ChatCreate) check() error {
	...
	if _, ok := cc.mutation.GroupID(); !ok {
		return &ValidationError{Name: "group_id", err: errors.New(`ent: missing required field "Chat.group_id"`)}
	}
	...
	if _, ok := cc.mutation.Time(); !ok {
		return &ValidationError{Name: "time", err: errors.New(`ent: missing required field "Chat.time"`)}
	}
	if _, ok := cc.mutation.MessageType(); !ok {
		return &ValidationError{Name: "message_type", err: errors.New(`ent: missing required field "Chat.message_type"`)}
	}
	if _, ok := cc.mutation.MessageContent(); !ok {
		return &ValidationError{Name: "message_content", err: errors.New(`ent: missing required field "Chat.message_content"`)}
	}
	return nil
}
